...
import type { Role } from "@/lib/firebase/AuthContext";
...
export default function NavSidebar({ isOpen, onClose, role }: NavSidebarProps) {
            ...
            <div className={`fixed top-0 right-0 h-full w-72 bg-cream-bg border-l border-accent/40 z-[101] transform transition-transform duration-300 ease-in-out ${isOpen ? "translate-x-0" : "translate-x-full"} flex flex-col p-6 shadow-2xl`}>
                ...
                <div className="flex-1 space-y-2 mt-4">
                    ...
                    >
                        ...
                        <span className="text-sm font-bold tracking-wide">{isTailor ? "Seller Dashboard" : "Dashboard Home"}</span>
                    </Link>
                    ...
                    >
                        ...
                        <span className="text-sm font-bold tracking-wide">My Orders</span>
                    </Link>
                    ...
                    {isTailor && (
                        <>
                            ...
                            >
                                ...
                                <span className="text-sm font-bold tracking-wide">Add Shop</span>
                            </Link>
